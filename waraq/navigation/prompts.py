...
def answer_system() -> str:
    return (
        ...
        "يجب أن تتضمن إجابتك دائماً مرجعاً صريحاً للقسم أو المعيار والصفحات التي استندت إليها. "
...
def answer_prompt(query: str, leaf_metadata: list[dict], leaf_content: str) -> str:
    sources = "\n".join(
        f"- {m['title']} (صفحات {m['start_page']}–{m['end_page']}, id: {m['id']})"
    ...
    return (
        ...
        "في حقل citation، استخدم بيانات المصدر الأكثر صلة بالإجابة من القائمة أعلاه."
    )
